    ...
    <div className="container" >
      ...
      <div className="content">
         <div className="contentText">
            ...
            <p>{ this.state. users ? 
               <div>
               <p>Author: {this.state.users[0].first_name} {this.state.users[0].last_name}</p>
      ...
      <div className="content">
         <div className="contentText">
            ...
            <p>{ this.state. users ? 
               <div>
               <p>Author: {this.state.users[1].first_name} {this.state.users[1].last_name}</p>
      ...
      <div className="content">
         <div className="contentText">
            ...
            <p>{ this.state. users ? 
               <div>
               <p>Author: {this.state.users[2].first_name} {this.state.users[2].last_name}</p>
